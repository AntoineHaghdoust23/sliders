      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="hero-visual relative w-full max-w-lg mx-auto lg:mx-0">
            ...
            <div className="bg-stone-100 rounded-xl border border-stone-300 overflow-hidden shadow-2xl">
              {/* Title bar */}
              <div className="flex items-center gap-2 px-4 py-2 bg-stone-200 border-b border-stone-300">
              ...
              <div className="flex">
                ...
                {/* Slider sidebar */}
                <div className="w-[180px] bg-white border-l border-stone-200 flex flex-col">
                  {/* Header */}
                  <div className="p-3 border-b border-stone-200">
                    <div className="flex items-center gap-2">
                      <img src="/logo.png" alt="Slider" width={20} height={20} className="rounded" />
                      <div>
                        <p className="text-stone-900 text-xs font-semibold">Slider</p>
                        <p className="text-stone-500 text-[8px]">Slide creation made simple</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 p-2 space-y-2">
                    <div className="bg-stone-100 rounded-lg p-2 text-[10px] text-stone-700">
                  ...
                  <div className="p-2 border-t border-stone-200">
                    <div className="bg-stone-100 rounded-lg px-2 py-1.5">
